...
namespace FirstSeleniumTests.Pages.RegistrationPage
{
    ...
    {        
        ...
        public IWebElement ErrorMessagesForNames
        {
            get
            {
                By ErrorMessagesForNamesXPath = By.XPath("//*[@id=\"pie_register\"]/li[6]/div/div/span");
            
                this.Wait.Until(ExpectedConditions.ElementExists(ErrorMessagesForNamesXPath));
                return this.Driver.FindElement(ErrorMessagesForNamesXPath);
            }
        }
        ...
        public IWebElement ErrorMessagesForPhone
        {
            get
            {
                By ErrorMessagesForPhoneXPath = By.XPath("//*[@id=\"pie_register\"]/li[6]/div/div/span");
                this.Wait.Until(ExpectedConditions.ElementExists(ErrorMessagesForPhoneXPath));
                return this.Driver.FindElement(ErrorMessagesForPhoneXPath);
            }
        }
